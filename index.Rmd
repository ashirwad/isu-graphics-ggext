...
.panel[.panel-name[Fatal crash summary by state, 2019]
...
```{r ggimage-demo1-1, include = FALSE}
tibble(
  country = c(
...
`r chunk_reveal("ggimage-demo1-1")`

---

```{r ggimage-demo1-2, include = FALSE}
ggplot(
  ggimage_df,
  aes(
    x = fct_reorder(
...
`r chunk_reveal("ggimage-demo1-2")`

---

```{r ggimage-demo1-3, include = FALSE}
ggimage_part1 +
  labs(
    title = paste(
...
`r chunk_reveal("ggimage-demo1-3")`
...
## Check [ggimage tutorial]("https://guangchuangyu.github.io/2017/04/ggimage/") to learn more 
...
knitr::include_url(
  "https://guangchuangyu.github.io/2017/04/ggimage/", height = "600px"
)
```
...
## Check [ggthemes website]("https://jrnold.github.io/ggthemes/index.html") to learn more 
...
knitr::include_url(
  "https://jrnold.github.io/ggthemes/index.html", height = "600px"
)
```
...
### - Garrick Aden-Buie for [.blue[xaringanExtra]](https://github.com/gadenbuie/xaringanExtra), and
### - Developers of ggplot2 extensions
